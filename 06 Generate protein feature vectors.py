...
protein_file = "./data/uniprotkb_human.csv"  # Protein sequence file
...
# Save to CSV file
output_df.to_csv("./data/human_protein_feature_vectors.csv", index=False)
output_df.to_csv("./data/human_protein_feature_vectors.txt", index=False, sep='\t')
