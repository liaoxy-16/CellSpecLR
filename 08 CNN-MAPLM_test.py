...
# Load data
file_path = "./data/human_protein_feature_vectors.txt"
...
# Save DataFrame
output_df.to_csv("./data/human_protein_prediction_label.csv", index=False)
output_df.to_csv("./data/human_protein_prediction_label.txt", index=False, sep='\t')
